...
func mmc(u int64, n int32, c string) models.HipstershopMoney { return models.HipstershopMoney{Units: u, Nanos: n, CurrencyCode: c} }
func mm(u int64, n int32) models.HipstershopMoney            { return mmc(u, n, "") }

func TestIsValid(t *testing.T) {
	tests := []struct {
		name string
		in   models.HipstershopMoney
		want bool
	}{
...
func TestAreSameCurrency(t *testing.T) {
	type args struct {
		l models.HipstershopMoney
		r models.HipstershopMoney
	}
	tests := []struct {
		name string
		args args
